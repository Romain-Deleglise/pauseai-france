...
En 2022, les experts en IA [estimaient qu'il faudrait attendre ~2060](https://aiimpacts.org/2022-expert-survey-on-progress-in-ai/) pour qu'une machine surpasse l'humain dans toutes les tâches. Trois ans plus tard, la [prédiction agrégée sur Metaculus](https://www.metaculus.com/questions/5121/when-will-the-first-general-ai-system-be-devised-tested-and-publicly-announced/) situe l'AGI aux alentours de 2030 — un recul de 30 ans en seulement 3 ans. Les progrès concrets expliquent ce basculement :
...
- Le [coût d'inférence](https://hai.stanford.edu/ai-index/2025-ai-index-report/research-and-development) d'un modèle aussi performant que GPT-3.5 a été divisé par plus de 280 entre fin 2022 et fin 2024.
