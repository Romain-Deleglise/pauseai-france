export default {
	...
	liens_utiles_page: {
		...
		filter_category: 'Catégorie (multi-sélection)',
		filter_type: 'Type de média (multi-sélection)',
		count_singular: 'ressource',
		count_plural: 'ressources',
		count_total: 'sur',
		reset: 'Réinitialiser',
		updated: 'Mise à jour :',
		empty: 'Aucune ressource ne correspond à votre recherche.',
		toc_title: 'Sections',
		cta_title: 'Une ressource à suggérer ?',
		cta_desc:
		...
		mt_org: 'Organisation',
		mt_declaration: 'Déclaration',
		mt_tool: 'Outil',
		mt_site: 'Site',
		mail_subject: 'Suggestion de ressource pour /ressources',
		mail_body_intro: 'Bonjour,',
		mail_body_line1: 'Je vous propose la ressource suivante pour la page /ressources :',
		mail_body_title: '- Titre : ',
		mail_body_url: '- URL : ',
