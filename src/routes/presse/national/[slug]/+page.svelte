...
<div class="page">
	...
	<nav class="pr-nav">
		<div class="nav-link-wrapper">
			{#if data.prev}
				<a href="/presse/national/{data.prev.slug}" class="nav-link nav-prev">
		...
		<div class="nav-link-wrapper nav-link-right">
			{#if data.next}
				<a href="/presse/national/{data.next.slug}" class="nav-link nav-next">
					<span class="nav-label">
