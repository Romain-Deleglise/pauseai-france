...
<section class="wrap" data-pagefind-ignore>
    <div class="hero">
        ...
        <div class="hero-text">
            ...
            <p class="subtitle">Intelligence Artificielle : Sécuriser les Pratiques, Contenir les Risques</p>
...
<style>
    ...
    .hero-text { position: absolute; inset: auto 0 0 0; padding: 1rem; background: linear-gradient(180deg, rgba(0,0,0,0.0) 0%, rgba(0,0,0,0.55) 60%, rgba(0,0,0,0.75) 100%); color: #fff; }
    .hero-text h1 { margin: 0 0 0.25rem 0; font-size: 1.25rem; }
    .hero-text .subtitle { margin: 0 0 0.25rem 0; font-weight: 600; }
    .hero-text .cta { margin: 0; opacity: 0.9; }

    .two-col { display: grid; gap: 1.25rem; grid-template-columns: 1fr; margin-top: 1.25rem; }
    @media (min-width: 760px) { .two-col { grid-template-columns: 1fr 1fr; } }
    .features { list-style: none; padding: 0; margin: 0.5rem 0 0 0; }
    ...
    fieldset.choices { border: 1px solid #e5e5e5; border-radius: 8px; padding: 0.75rem 1rem; }
    fieldset.choices legend { padding: 0 0.25rem; font-weight: 600; }
    .check { display: flex; align-items: center; gap: 0.5rem; margin: 0.25rem 0; }
    .msg { margin: 0.25rem 0 0; font-weight: 600; }
    ...
    .footer { display: flex; align-items: center; gap: 0.5rem; margin-top: 1rem; }
    .logo { height: 22px; }
